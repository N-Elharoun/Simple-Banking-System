...
namespace BankingSystemApp
{
    internal class Program
    {
        ...
        static void Deposit(Dictionary<int , BankAccount> accounts)
        {
            ...
            Console.WriteLine($"Deposit successful! New balance: {accounts[accountNumber].Balance:C}");
        }
        static void Withdraw(Dictionary<int , BankAccount> accounts)
        {
            ...
            {
                Console.WriteLine($"Withdrawal successful! New balance: {accounts[accountNumber].Balance:C}");
            }
            else
            {
        ...
        static void ViewAccount(Dictionary<int , BankAccount > accounts)
        {
            Console.WriteLine("\nEnter your account number:");
            int accountNumber = GetValidAccountNumber(accounts);
           
            Console.WriteLine($"Account Holder: {accounts[accountNumber].Name}");
            Console.WriteLine($"Account Balance: {accounts[accountNumber].Balance:C}");
        }
